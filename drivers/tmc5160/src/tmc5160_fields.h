...
#define TMC5160_V1_MASK                               0x0FFFFF // V1 // First acceleration / deceleration phase threshold velocity (unsigned) 0: Disables A1 and D1 phase, use AMAX, DMAX only
#define TMC5160_V1_SHIFT                              0 // min.: 0, max.: 1048575, default: 0
